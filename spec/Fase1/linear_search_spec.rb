...
RSpec.describe LinearSearch do
  ...
  context "Element is present" do
    search1 = LinearSearch.new([10, 20, 80, 30, 60, 50, 110, 100, 130, 170], 110)
    it "search1 at index 6" do
      expect(search1.linear_search).to eq("Element 110 is present at index 6")
    end
    search2 = LinearSearch.new([5, 15, 6, 9, 4], 9)
  ...
  context "Element is not present" do
    search1 = LinearSearch.new([10, 20, 80, 30, 60, 50, 110, 100, 130, 170], 180)
    ...
    it "search2 not present in array" do
      search2 = LinearSearch.new([5, 15, 6, 9, 4], 10)
