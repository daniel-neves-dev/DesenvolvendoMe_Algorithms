...
require_relative "lib/DesenvolvendoMe_Algorithms/version"

Gem::Specification.new do |spec|
  spec.name = "DesenvolvendoMe_Algorithms"
  spec.version = DesenvolvendoMeAlgorithms::VERSION
  spec.authors = ["daniel-neves-dev"]
